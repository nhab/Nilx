...
function Block(...a)
{
    var options = {}; 
    headerHeight=45;
    centerStyle=";display: table-cell; vertical-align: middle;margin:5px 5px 5px 15px;font-weight:900px;";
    ...
    divHead.setAttribute("style","height:"+headerHeight+"px;"+centerStyle);

    var dvTitle = document.createElement("div");
    dvTitle.setAttribute("class",'blockTitle');
    dvTitle.setAttribute("style","height:"+headerHeight-2+"px;"+centerStyle+";font-wight:700px;");
