var json1=`{
    ...
    json1+=`,{"title":"Mental skills",
        "topic":
            [
                {"href":"/nilx/Topics/softskills/howtothink.htm" ,
                "tooltip":"Thinking is a mental tool works base on the cause and effect law. it is a proccess to use imagination, intution  and other higher facaulties to find the cause of an effect and use it",
                "caption":"How to think"
                },
                {"href":"/nilx/Topics/softskills/howtolearn.htm" ,
                "caption":"How to learn"
                },
                {"href":"Topics/Wisdom/unlearningwisdom.htm",
                "caption":"Unlearning"
                },
                {"href":"/nilx/Topics/softskills/howtosloveaproblem.htm" ,
                "caption":"How to solve a problem"
                },
                {"href":"/nilx/Topics/softskills/howtosearch.htm" ,
                "caption":"How to search"
                },
                {"href":"/nilx/Topics/softskills/howtodebug.htm" ,
                "caption":"How to debug"
                },
                {"href":"/nilx/Topics/softskills/howtocommunicate.htm" ,
                "caption":"how to communicate"
                },
                {"href":"/nilx/Topics/softskills/howtomanage.htm" ,
                "caption":"How to manage "
                },
                {"href":"/nilx/Topics/softskills/howtoreadcode.htm" ,
                "tooltip":"There is main functions in the code file which may have used some other functions inside.you should begin by the main class of the project and the main function(s) of the classs and follow the code."
                ,"caption":"How to read code"
                },
                {"tooltip":"عملی که پشت آن نتیجه خردمندانه ای که در اثر تجارب قبلی بهو فکر به آن رسیده ایم میباشد.مثلا برای جستجوی آموزش اتوفک نمیزنیم آموزش اتوفک بلکه ابتدا لغات پیشرفته این علم را در میاریم وآنرا جستجو میکنیم که در مورد اتوفک اتریبیوتز میباشد.. ",
                "caption":"wise move"
                }
            ]
        }`;
    ...
    json1+=`,{ "title":"Web Dev",
        "topic":
        [
            {"caption":"Website Security Checklis","href":"https://www.upguard.com/blog/the-website-security-checklist",
            "title":"1. Ensure Sitewide SS:Encrypt website traffic 2. Verify the SSL Certificate:Stay on top of expiration and trust.." ,
            "href":"#"
            },
            {"caption":"web performance optimization",
            "title":"Web performance optimization occurs by monitoring and analyzing the performance of your web application and identifying ways to improve it.Web applications are a mixture of server-side and client-side code. ",
            "href":"#"
            },
